...
import 'package:waether_app/models/serializers.dart';
...
class BuiltValueConverter extends JsonConverter {
  ...
  T _deserializer<T>(dynamic value) =>
      jsonSerializers.deserializeWith(
  ...
  BuiltList<T> _deserializeListOf<T>(Iterable value) =>
      BuiltList(
